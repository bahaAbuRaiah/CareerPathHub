...
const KeywordSuggestions = ({ jobDescription, skills, onBack }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-2 mt-8">
        ...
        <button type="button" className="ml-auto py-2 px-4 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition">Finish</button>
      </div>
    </div>
  );
};
