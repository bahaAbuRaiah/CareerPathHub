...
### 🎓 A Web Platform Bridging the Gap Between Education and Employment in the IT Sector

---

## 📘 Overview
**Career Path Hub** is a web-based application designed to bridge the gap between education and employment in Jordan’s IT sector.  
It provides two key services:

1. 🧠 **IT Aptitude Assessment** – helps high school graduates identify their technical strengths and choose the right IT specialization.  
2. 💼 **Job & Training Search Platform** – enables IT graduates to find and apply for relevant job and training opportunities.
